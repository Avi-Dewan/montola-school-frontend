...
export default function ChapterStudentPage() {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">{progress?.chapterTitle || "Course Overview"}</h1>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-6">
                <h2 className="text-lg font-semibold text-blue-900 mb-2">Ready to learn?</h2>
                <p className="text-blue-700 mb-4">Select a topic from the sidebar to start watching videos or taking quizzes.</p>
